...
object Proposals : IntIdTable("proposal")
{
    ...
    val currentEmployeeStatus = reference("current_employee_status_id", EmployeeStatuses)
    val proposedEmployeeStatus = reference("proposed_employee_status_id", EmployeeStatuses)
}
